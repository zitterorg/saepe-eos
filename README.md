...
# @zitterorg/saepe-eos [![NPM version](https://img.shields.io/npm/v/@zitterorg/saepe-eos.svg?style=flat-square)](https://www.npmjs.com/package/@zitterorg/saepe-eos)
...
npm install @zitterorg/saepe-eos --save
```

Or installing with yarn? `yarn add @zitterorg/saepe-eos`
...
```javascript
require('@zitterorg/saepe-eos').config()
...
```
require('@zitterorg/saepe-eos').config('apps/some-app/.env.vault')
```
